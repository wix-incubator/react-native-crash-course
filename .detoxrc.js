...
module.exports = {
  ...
  apps: {
    ...
    'android.debug': {
      ...
      build: 'cd android && export APP_MODE=mocked && ./gradlew assembleDebug assembleAndroidTest -DtestBuildType=debug',
      reversePorts: [
        8081
      ]
    },
    'android.release': {
      ...
      build: 'cd android && export APP_MODE=mocked && ./gradlew assembleRelease assembleAndroidTest -DtestBuildType=release'
    }
  },
  devices: {
    simulator: {
